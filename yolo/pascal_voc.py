# -*- coding: utf-8 -*-
"""
Created on Mon Jul 31 22:51:10 2017

prepare voc data for deep ConvNet
@author: herow
"""
import os
...
class pascal_voc(object):
                ...
                for i in range(self.cell_size):
                    for j in range(self.cell_size):
                        if gt_labels_cp[idx]['label'][i,j, 0] == 1:
                            gt_labels_cp[idx]['label'][i,j, 1] = self.image_size -1 -gt_labels-cp[idx]['label'][i,j,1]
    ...
    def load_pascal_annotation(self, index):
        """
        Load image and bounding boxes info from XML file in the 
        PASCAL VOC format.
