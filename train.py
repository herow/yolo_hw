# -*- coding: utf-8 -*-
"""
Created on Wed Aug  9 02:37:43 2017
train yolo_small
@author: gis
"""
...
from yolo.yolo_small import YOLONet
...
class Solver(object):
    def __init__(self, net, data):
        ...
        if self.weights_file is not None:
            print('Restoring weights from: ' + self.weigts_file)
            self.saver.restore(self.sess, self.weigts_file)
